...
DEFAULT_CONFIG = {
    ...
    "kanban": {
        # Optional plugin that reserves a repository workspace before a worktree
        # worker starts. Empty preserves Hermes' built-in workspace lifecycle.
        # Registration alone is inert; selection is explicit so installing a
        # plugin cannot silently change dispatch semantics.
        "workspace_provider": "",
