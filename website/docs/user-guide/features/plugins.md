...
| A **Kanban Git workspace coordinator** | Backend plugin — `ctx.register_workspace_provider()` | [Workspace Provider Plugins](../../developer-guide/workspace-provider-plugin.md) |
